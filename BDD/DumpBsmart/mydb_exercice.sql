...
CREATE TABLE `exercice` (
  ...
  `enoncer` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idExercice`),
  KEY `fk_exercice_1_idx` (`idFormation`),
  CONSTRAINT `fk_exercice_1` FOREIGN KEY (`idFormation`) REFERENCES `formation` (`idFormation`) ON DELETE NO ACTION ON UPDATE NO ACTION
